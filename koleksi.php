...
<body>
  ...
  <section id="atas">
    <div class="container h-100">
      <div class="row h-100 text-center d-flex align-items-center" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-offset="300">
        <h3 class="fw-bold">Koleksi</h2>
      </div>
    </div>
  </section>
  ...
  <section id="kemeja">
    <div class="container">
      <div class="row text-center mb-5 mt-5" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-offset="300">
        <h3 class="fw-bold">Kemeja</h3>
      </div>
      <div class="row h-100 text-center">
        ...
        //tampil data koleksi
        $no = 1;
        $tampil = mysqli_query($koneksi, "SELECT * FROM koleksi  WHERE kategori = 'kemeja' ORDER BY id_produk DESC");
        while ($data = mysqli_fetch_array($tampil)) :
        ?>
          <div class="col-md-3" data-aos="flip-left" data-aos-duration="750" data-aos-delay="100" data-aos-offset="300">
            <div class="card-koleksi">
              <a data-bs-toggle="modal" data-bs-target="#modalKemeja<?= $data['id_produk']; ?>" href="#hero"><img src="assets/img/<?= $data['gambar']; ?>" alt="" class="img-fluid"></a>
  ...
  <section id="dress">
    <div class="container">
      ...
      <div class="row h-100 text-center">
        ...
        //tampil data artikel
        $no = 1;
        $tampil = mysqli_query($koneksi, "SELECT * FROM koleksi  WHERE kategori = 'dress' ORDER BY id_produk DESC");
        while ($data = mysqli_fetch_array($tampil)) :
        ?>
          <div class="col-sm-3" data-aos="flip-left" data-aos-duration="750" data-aos-delay="100" data-aos-offset="300">
            <div class="card-koleksi">
              <a data-bs-toggle="modal" data-bs-target="#modalDress<?= $data['id_produk']; ?>" href="#hero"><img src="assets/img/<?= $data['gambar']; ?>" alt="" class="img-fluid"></a>
              <div class="intro mt-3">
                <h3><?= $data['nama']; ?></h3>
              </div>
            </div>
  ...
  <section id="Kain">
    <div class="container mb-5">
      <div class="row mb-5 mt-5" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-offset="300">
        <h3 class="fw-bold text-center">Kain</h3>
      </div>
      <div class="row h-100 text-center">
        <?php

        //tampil data koleksiKain
        $no = 1;
        $tampil = mysqli_query($koneksi, "SELECT * FROM koleksi  WHERE kategori = 'kain' ORDER BY id_produk DESC");
        while ($data = mysqli_fetch_array($tampil)) :
        ?>
          <div class="col-sm-3" data-aos="flip-left" data-aos-duration="750" data-aos-delay="100" data-aos-offset="300">
            <div class="card-koleksi">
              <a data-bs-toggle="modal" data-bs-target="#modalKain<?= $data['id_produk']; ?>" href="#hero"><img src="assets/img/<?= $data['gambar']; ?>" alt="" class="img-fluid"></a>
              <div class="intro mt-3">
                <h3><?= $data['nama']; ?></h3>
              </div>
            </div>
